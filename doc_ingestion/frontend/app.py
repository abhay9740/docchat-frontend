...
/* ══════════════════════════════════════════════════════
   SIDEBAR  — let Streamlit own the show/hide mechanics;
   we ONLY set colours and dimensions.
   ══════════════════════════════════════════════════════ */
...
/* Sidebar toggle button (the ‹ › chevron) — visible and styled */
...
@media (max-width: 768px) {
    .right-panel {
        ...
        border-radius: 12px !important;
        margin-bottom: 1rem; padding: 1rem !important;
    }
}
.right-panel h3 {
...
.logo-teal {
    background: linear-gradient(135deg, #1a7a64, #2ea88a);
    color: white !important;
    transform: rotate(-6deg); left: calc(50% - 40px); z-index: 2;
}
.logo-blue {
    background: linear-gradient(135deg, #3b5fd4, #6070e8);
    color: white !important;
